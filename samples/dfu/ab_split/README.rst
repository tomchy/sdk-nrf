...
The application image is verified by checking the value of :kconfig:``CONFIG_EMULATE_APP_HEALTH_CHECK_FAILURE``symbol.
...
This sample uses bootloader request subsystem to request a successfull confirmation of the image instead of modifying the image trailer directly.
...
The implementation of those checks can be found innside :file:`src/ab_utils.c`.
