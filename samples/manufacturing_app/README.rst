...
Running the manufacturing application sample will initialize the provisioning process of a device in a manner compatible with Trusted Firmware-M (TF-M).
...
When built for the ``nrf54lv10dk/nrf54lv10a/cpuapp`` board target, this image by default also includes the :ref:`provisioning_image_net_core` sample as an image for the network core (``nrf54lv10dk/nrf54lv10a/cpunet`` board target).
